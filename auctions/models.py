...
#this model reperents the Types of the auctions
class Category(models.Model):
    ...
    @property
    #getter modification to get the count of active auctions of the specifyed class
    def count_active_auctions(self):
        return Auction.objects.filter(category=self).count()

#this model represents the auction itself
